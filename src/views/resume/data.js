  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        techStack: ['React-Native/Redux/', 'React-Navigation', 'ImmerJs'],
      },
    ],
  },
  // {
...
export const projectData = [
  ...
  // web3
    ...
    mainJobs: [
      '1. 利用 RainbowKit 集成 Web3 的钱包，Wagimi 集成 web3 的合约调用',
    ],
    mainAchivements: [
      '1. 钱包的授权签名，多钱包地址的无缝切换',
    ],
  },
  {
    title: (
